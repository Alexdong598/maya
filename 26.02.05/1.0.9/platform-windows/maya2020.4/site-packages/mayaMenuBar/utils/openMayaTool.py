...
def open_maya_smarter():
    ...
    try:
        ...
        def get_hal_file_path():
            ...
            if PY2:
                print("[DEBUG] HAL_CONFIG_PATHS: {}".format(HAL_CONFIG_PATHS))
            else:
            ...
            for path in HAL_CONFIG_PATHS:
                ...
                try:
                    if "maya.hal" in os.listdir(path):
                        if PY2:
                            print("[DEBUG] Found 'maya.hal' candidate: {}".format(path))
                        else:
            ...
            if project_paths:
                ...
                if PY2:
                    print("[DEBUG] Selected preferred project-level config path: {}".format(selected_path))
                else:
                ...
                if PY2:
                    print("[DEBUG] No project path found. Selected config path based on length: {}".format(selected_path))
                else:
        ...
        def get_packages_section(path):
            ...
            if PY2:
                print("[DEBUG] Attempting to read packages from: {}".format(file_path))
            else:
            ...
            try:
                with open(file_path, 'r') as file:
                    ...
                    if len(parts) > 1:
                        ...
                        if PY2:
                            print("[DEBUG] Found packages section:\n---\n{}\n---".format(packages_section))
                        else:
                ...
                if PY2:
                    warning("Error processing file: {}".format(e))
                else:
        ...
        def get_clean_packages_list(packages_section):
            ...
            if PY2:
                print("[DEBUG] Final formatted packages list: {}".format(packages))
            else:
        ...
        print("="*50)
        if PY2:
            print("[DEBUG] FINAL COMMAND to be executed:\n{}".format(afx_cmd))
        else:
        ...
        try:
            ...
            if PY2:
                warning("Failed to launch Maya: {}".format(e))
            else:
        ...
        if PY2:
            warning("A critical error occurred in the script: {}".format(str(e)))
        else:
