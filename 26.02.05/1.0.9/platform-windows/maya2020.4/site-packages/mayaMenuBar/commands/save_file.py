...
import importlib
import sys
from ..compat import PY2, to_int_pointer

def maya_main_window():
    """Get Maya's main window as a parent widget."""
    ptr = omui.MQtUtil.mainWindow()
    return wrapInstance(to_int_pointer(ptr), QWidget)
...
class SaveSceneWindow(QDialog):
    ...
    def update_version_combo(self):
        ...
        if PY2:
            version_str = "v{:03d}".format(next_version)
        else:
        ...
        if is_library:
            ...
            if PY2:
                new_filename = "{}_{}_{}_{}_{}.ma".format(self.HAL_PROJECT_ABBR, asset, self.HAL_TASK, version_str, self.HAL_USER_ABBR)
            else:
            ...
            if PY2:
                new_filename = "{}_{}_{}_{}_{}_{}.ma".format(self.HAL_PROJECT_ABBR, sequence, shot, self.HAL_TASK, version_str, self.HAL_USER_ABBR)
            else:
    ...
    def on_save_clicked(self):
        ...
        if PY2:
            confirm = QMessageBox.question(
                self,
                "Confirm Save",
                "Are you sure you want to save Maya file to:\n{}".format(absolute_path),
        ...
        if confirm == QMessageBox.Yes:
            try:
                ...
                if PY2:
                    QMessageBox.critical(self, "Save Failed", "Error saving file:\n{}".format(str(e)))
                else:
