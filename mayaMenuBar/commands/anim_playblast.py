    ...
    def on_get_sg_frames(self):
        try:
            ...
            if cut_in is None or cut_out is None:
                QtWidgets.QMessageBox.warning(self, "Warning", "ShotGrid data missing cut in/out values")
                return
                
            self.start_frame_line_edit.setText(str(cut_in))
            self.end_frame_line_edit.setText(str(cut_out))
