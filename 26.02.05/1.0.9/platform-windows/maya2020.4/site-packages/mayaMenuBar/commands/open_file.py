...
class OpenSceneWindow(QDialog):
    ...
    def __init__(self, parent=maya_main_window()):
        ...
        if OpenSceneWindow._instance:
            try:
                ...
                if PY2:
                    print("Error cleaning up previous instance: {}".format(str(e)))
                else:
    ...
    def update_file_info(self):
        ...
        try:
            ...
            if PY2:
                info = [
                    "File: {}".format(selected_file),
                    "Path: {}".format(file_path),
                    "Size: {:.2f} KB".format(file_stats.st_size / 1024),
                    "Modified: {}".format(modified_time)
                ]
            else:
                info = [
            ...
            if version_match:
                if PY2:
                    info.append("Version: {}".format(version_match.group(0)))
                else:
            ...
            if user_match:
                if PY2:
                    info.append("Saved by: {}".format(user_match.group(1)))
                else:
            ...
            if PY2:
                self.file_info_text.setText("Error reading file info: {}".format(str(e)))
            else:
    ...
    def on_load_clicked(self):
        ...
        if not os.path.isfile(absolute_path):
            if PY2:
                QMessageBox.warning(self, "File Not Found", "File does not exist:\n{}".format(absolute_path))
            else:
        ...
        try:
            ...
            try:
                ...
                if unknown_nodes:
                    ...
                    if PY2:
                        print("// Warning: File opened with {} unknown nodes. Missing plugins?".format(len(unknown_nodes)))
                    else:
                ...
                if PY2:
                    QMessageBox.critical(self, "Load Failed", "Error opening file:\n{}\nCheck Script Editor for details.".format(str(e)))
                else:
    ...
    def closeEvent(self, event):
        ...
        try:
            ...
            if PY2:
                print("Error during window close: {}".format(str(e)))
            else:
...
def open_new_file():
    ...
    try:
        ...
        if PY2:
            print("Error creating new scene: {}".format(str(e)))
        else:
